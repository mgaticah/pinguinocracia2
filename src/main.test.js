...
describe('Complete game flow', () => {
  ...
  describe('4: map transition', () => {
    ...
    it('clears groups', () => { gameScene._isTransitioning = false; gameScene._transitionToMap('map_level2'); dc(); expect(gameScene.enemyGroup.clear).toHaveBeenCalledWith(true, true); expect(gameScene.powerupGroup.clear).toHaveBeenCalledWith(true, true); expect(gameScene.projectileGroup.clear).toHaveBeenCalledWith(true, true) })
    ...
    it('grants ally', () => { gameScene._isTransitioning = false; gameScene._transitionToMap('map_level2'); dc(); expect(gameScene.allyGroup.add).toHaveBeenCalled() })
  })
